...
def make_grid_art(
    ...
    for x in range(x_size):
        for y in range(y_size):
            ...
            x_points = [x - hyst[0], x - hyst[1], x + hyst[2], x + hyst[3], x - hyst[0]]
            y_points = [y + hyst[4], y - hyst[5], y - hyst[6], y + hyst[7], y + hyst[4]]
...
if __name__ == "__main__":
    print("Hello World")
    make_grid_art(x_size=10, y_size=10, grout_size=0.2, h_num=4)
