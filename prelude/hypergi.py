...
def _make_grid_art(n_x: int = 15, n_y: int = 10, grout_size: float = 0.2, h_num: int = 10):
        """
...
class Intro(Scene):
    ...
    def construct(self):
        ...
        squares = _make_grid_art(n_x=13, n_y=8, grout_size=0.5, h_num=0)

        squares2 = _make_grid_art(n_x=13, n_y=8, grout_size=0.5, h_num=30)

        squares3 = _make_grid_art(n_x=13, n_y=8, grout_size=0.5, h_num=13)
        ...
        self.play(
            ...
            *[Broadcast(square, square.get_center()) for square in squares],
